package com.github.thedeathlycow.thermoo.patches.config.translate;
...
public final class Translate {
    ...
    public static String mainCategoryKey(ConfigClassHandler<?> handler) {
        return categoryKey(handler, ThermooPatchesConfig.MAIN_CATEGORY_NAME);
    }
    ...
    public static String mainGroupKey(ConfigClassHandler<?> handler, String group) {
        return groupKey(handler, ThermooPatchesConfig.MAIN_CATEGORY_NAME, group);
    }
